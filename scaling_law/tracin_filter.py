...
checkpoint_grads = torch.load("tracin_grads_1e5.pt")
print(len(checkpoint_grads))
# print(checkpoint_grads)


# def get_all_influence_scores(
#     model, dataset, checkpoint_grads, tokenizer, device, batch_size=16
# ):
#     """
#     Computes TracIn influence scores for each example in the dataset.
...
#     model, train_dataset, checkpoint_grads, tokenizer, device, batch_size=16
# )
